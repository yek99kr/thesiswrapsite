  ...
  return (
    <>
      ...
      <div className="grid grid-cols-3 w-full pb-10">
        <ReactPlayer loop width="100%" url="https://vimeo.com/684258810" />
        <ReactPlayer loop width="100%" url="https://vimeo.com/684258834" />
        <ReactPlayer loop width="100%" url="https://vimeo.com/684258847" />
      </div>
    </>
  );
};
